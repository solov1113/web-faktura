    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Aktualizuj produkt</li>
            </ol>

            <div class="panel panel-default">

                <div class="panel-heading">
                    <div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Aktualizuj produkt</div>
                </div>

                <form class="form-horizontal" id="updateProdukt" action="updateProdukt" method="GET" enctype="multipart/form-data">
                    ...
                    <div class="modal-body" style="overflow:auto;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nazwaProduktu" value="<%= request.getParameter("nazwaProduktu")%>" name="nazwaProduktu" autocomplete="off" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="cenaNetto" value="<%= request.getParameter("cenaNetto")%>" name="cenaNetto" autocomplete="off" required>
                            </div>
                        </div>
